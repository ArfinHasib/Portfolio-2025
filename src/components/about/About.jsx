                ...
                <div className="space-y-4">
                    <Reveal>
                        <p className="leading-relaxed text-zinc-300">
                            ...
                            ey! I&apos;m Arfin, if you haven&apos;t already gathered that by
                            now. I&apos;m a Designer turned software engineer from Dhaka,
                            Bangladesh. I specialize in the FrontEnd (React, Next), Backend, primarily Node and Express, but
                            love building with whatever tools are right for the job.
                        </p>
                    </Reveal>
                    <Reveal>
                        <p className="leading-relaxed text-zinc-300">
                            I currently work for EJ LLC as a Remote Full-Stack Dev. I also toss in my ¢2
                    ...
                    <Reveal>
                        <p className="leading-relaxed text-zinc-300">
                            Outside of work, I still love to play FootBall. Any given Sunday
